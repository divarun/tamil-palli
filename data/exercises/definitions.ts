...
export const exercises: Exercise[] = [
  ...
  {
    id: "ex-comprehension-kambaramayanam",
    title: "Kambaramayanam Comprehension",
    level: "expert",
    exerciseType: "comprehension",
    topicId: "exp-kambaramayanam",
    questions: [
      {
        type: "comprehension",
        passage: "கம்பராமாயணம் கம்பர் இயற்றிய மகாகாவியம். இது வால்மீகி இராமாயணத்தை தழுவி தமிழில் எழுதப்பட்டது. இதில் இராமன், சீதை, இலக்குவன், அனுமன், ராவணன் ஆகியோரின் கதை ஆறு காண்டங்களில் சொல்லப்படுகிறது. கம்பர் ராவணனை ஒரு கல்வியாளனாகவும் வீரனாகவும் சித்தரித்தார்.",
        passageTranslation: "Kambaramayanam is a great epic composed by Kambar. It is a Tamil retelling based on Valmiki's Ramayana. The story of Rama, Sita, Lakshmana, Hanuman, and Ravana is told across six Kandams (books). Kambar portrayed Ravana as both a scholar and a warrior.",
        question: "கம்பராமாயணம் எத்தனை காண்டங்களை கொண்டது?",
        answer: "ஆறு",
        choices: ["மூன்று", "நான்கு", "ஐந்து", "ஆறு"],
      },
    ],
  },
];
