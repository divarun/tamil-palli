  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-2 flex items-center gap-2 text-sm text-gray-500">
        ...
        <span>Advanced</span>
        <span>›</span>
        <span className="text-gray-800">All 8 Cases</span>
      </div>
      <div className="flex items-start justify-between gap-4 mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">All 8 Grammatical Cases</h1>
          <p className="tamil-text text-orange-600 text-lg">எட்டு வேற்றுமைகள்</p>
        </div>
        <button
          onClick={() => markTopicComplete("adv-cases8")}
      ...
      <div className="flex gap-3 mt-8">
        <Link href="/learn/advanced/sandhi" className="px-4 py-2 bg-orange-600 text-white rounded-xl text-sm font-medium hover:bg-orange-700 transition-colors">
          Next: Sandhi Rules →
        </Link>
      </div>
    </div>
