...
export const lessonPlan: LessonPlan[] = [
  ...
  { lesson: 35, title: "Silappatikaram — Introduction", level: "expert", topicIds: ["exp-silappatikaram"], goals: ["Learn about Kannagi and Kovalan", "Read selected verses from the epic", "Understand the structure of ancient Tamil epics"] },
  { lesson: 36, title: "Silappatikaram — Themes & Verses", level: "expert", topicIds: ["exp-silappatikaram"], goals: ["Read the Madurai Kandam excerpt", "Analyse themes: justice, chastity, fate", "Compare classical vs modern Tamil"] },
